...
int R_enable_val = 37000;  // initialize enable values high
int L_enable_val = 37000;
...
void setup()
{
  ...
  pwmWrite(right_enable, 37000);
  pwmWrite(left_enable, 37000);
...
void turn_left() // point turn
{
  ...
  pwmWrite(right_enable, 37000);  // decrese the value for a slower turn, increase it to go faster
  pwmWrite(left_enable, 37000);	  // decrese the value for a slower turn, increase it to go faster
 ...
 { 
...

  {
    L_enable_val -= (8*total);
      constrain(L_enable_val, 20000, 37000);  // may need to adjust
    
    R_enable_val += (8*total); 
      constrain(R_enable_val, 20000, 37000);
