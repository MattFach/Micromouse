...
void setup()
{
  ...
  pwmWrite(right_enable, 40000);
  pwmWrite(left_enable, 40000);
...
void turn_left() // point turn
{
  ...
  pwmWrite(right_enable, 40000);  // decrese the value for a slower turn, increase it to go faster
  pwmWrite(left_enable, 40000);	  // decrese the value for a slower turn, increase it to go faster
 ...
 { 
...

  {
    L_enable_val -= (8*total);
      constrain(L_enable_val, 20000, 40000);  // may need to adjust
    
    R_enable_val += (8*total); 
      constrain(R_enable_val, 20000, 40000);
